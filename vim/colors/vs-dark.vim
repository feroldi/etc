...
hi DiffOldLine             ctermfg=196
hi DiffOldFile             ctermfg=196
hi DiffNewFile             ctermfg=31
hi DiffAdd                 ctermfg=31        ctermbg=none
hi DiffAdded               ctermfg=31
hi DiffDelete              ctermfg=196        ctermbg=none
hi DiffRemoved             ctermfg=196
hi DiffChange              ctermfg=34        ctermbg=none
...
hi VisualNOS               ctermfg=none        ctermbg=233     cterm=bold
hi WarningMsg              ctermfg=196   
hi WildMenu                ctermfg=104      ctermbg=16
